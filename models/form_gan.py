...
class FormGenerator(nn.Module):
    ...
    def __init__(self, depth1=5, depth2=4, depth3=2, initial_size=6, dim=384, heads=4, mlp_ratio=4, drop_rate=0.5):
        ...
        self.positional_embedding_1 = nn.Parameter(torch.zeros(1, (initial_size**2), 384))
        self.positional_embedding_2 = nn.Parameter(torch.zeros(1, (initial_size*2)**2, 384//4))
        self.positional_embedding_3 = nn.Parameter(torch.zeros(1, (initial_size*4)**2, 384//16))
...
class FormDiscriminator(nn.Module):
    def __init__(self, diff_aug="translation,cutout,rotate", image_size=24, patch_size=4, input_channel=24, num_classes=1,
                 dim=384, depth=7, heads=4, mlp_ratio=4, drop_rate=0.):
        super(FormDiscriminator, self).__init__()
